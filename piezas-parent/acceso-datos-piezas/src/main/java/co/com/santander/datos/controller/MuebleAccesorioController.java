...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("muebleAccesorio")
public class MuebleAccesorioController {
	...
	public List<MuebleAccesorioDTO> getMuebleAccesoriosAll() {
		...
		return lstMuebleAcc.isEmpty() ?  new ArrayList<MuebleAccesorioDTO>() : muebleAccesorioMapper.listMuebleAccerosioEntitiesToDTOs(lstMuebleAcc);
	...
	public MuebleAccesorioDTO createMuebleAccesorio(@RequestBody MuebleAccesorioDTO muebleAccesorioDTO ){
		LoggerMessages.generateInitialLogSimple("", "");
		MuebleAccesorio muebleAccesorio = muebleAccesorioRepository.save(muebleAccesorioMapper.muebleAccesorioDTOToEntity(muebleAccesorioDTO));		
		return Objects.isNull(muebleAccesorio) ? new MuebleAccesorioDTO() : muebleAccesorioMapper.muebleAccesorioEntityToDTO(muebleAccesorio);
	}
