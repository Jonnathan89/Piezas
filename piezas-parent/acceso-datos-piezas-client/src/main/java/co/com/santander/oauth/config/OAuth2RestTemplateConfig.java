...
public class OAuth2RestTemplateConfig {
	...
	protected OAuth2ProtectedResourceDetails resource() {
		...
		log.info("[OAuth2RestTemplateConfig :: OAuth2ProtectedResourceDetails ] Constructing Header {} for Token {}", this.tokenUrl);
	...
	public OAuth2RestOperations restTemplate() {
		...
		log.info("[OAuth2RestTemplateConfig :: OAuth2RestOperations] get AccessTokenRequest");
